...
from models.RoutesAndVisits import Territory
from utils.util_functions import validate_name
from models.viewModel.TerritoryView import TerritoryView as TemplateView ,  UpdateTerritoryView as TemplateViews
...
# Update router name
TerritoryRouter = c = APIRouter()
SessionDep = Annotated[Session, Depends(get_session)]
UserDep = Annotated[dict, Depends(get_current_user)]

endpoint_name = "territory"  # Update this
db_model = Territory  # Update this
...
async def get_form_fields_for_territory(
    ...
    try:
        ...
        return {"data": territory_data, "html_types": get_html_types("territory")}
